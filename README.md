# genpark-unified-memory-moe-expert-offload-runtime-skill
...
> **GenPark AI Agent Skill** -- Unified memory MoE expert offload runtime with PCIe prefetch (KTransformers style)
